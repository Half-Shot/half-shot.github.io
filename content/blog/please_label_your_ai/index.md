...
description = "If you're going to generate it, do us the courtsey of a disclaimer"
date = 2025-01-08
[taxonomies]
...
Halfy blogposts are like buses, you wait half a year for one and then two come along at once.
...
bit of tech in the house was a DVD recorder. Otherwise, nothing. And it facinated me.
...
There is a big part of me that believes in keeping up with the times and adapting to change, but try as I might
I cannot love AI. LLMs appear constantly around what I do, and they never spark that joy. I've now connected
with my late grandfather's words about wanting to burn them down.
...
much fulfillment to my life through making music, drawing, photoshopping or building random janky websites as
a meme.
...
And right now I'm angry in the same way my Science teacher graded me down for not labeling my axis on a graph;
**PEOPLE ARE NOT LABELING THEIR SHIT**. 

I get it, you like AI. That's cool for you, and I don't want to burn down your ambitions. But for the love of
god, stop burning the goodwill of everyone else and just label that whatever you just generated contains AI.
...
issues they don't like, generate some crap code, and then expect the maintainers to form it into a fix. I want
to believe these people think they are helping.

Let me be clear; rather than oiling the gears, **you are filling them with mud.**

## So to be clear

I am probably never going to get on with AI, however good it gets. I enjoy the learning curve of a craft, I
get a lot out of fixing bugs with my human brain and I will play and sing in terrible quality til the day
I depart this Earth. I am not interested in the quality or productiveness, I get a thrill from just the
experience.
...
how much of that work is your own, and give us the ability to decide whether we want to engage with it.